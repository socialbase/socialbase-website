<section class="wrapper baser">
  <div class="container">
    <div class="row d-flex align-items-center">

      <div class="col-md-6 order-md-2 mb-5 mb-md-0 text-center">
        <img src="<?= ASSETS_IMAGES_URI; ?>/global/socialbase-seja-um-baser.svg" width="591" height="578" class="img-fluid" alt="" />
      </div>

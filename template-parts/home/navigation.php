<section class="navigation fixed-top">
	<nav class="navbar navbar-expand-lg">
		<div class="container">
			...
			<a href="<?= SITE_URL; ?>" class="navbar-brand"><img src="assets/layout/images/logos/socialbase-logo.svg" alt="SocialBase" /></a>
        ...
        <span class="icon-bar bottom-bar"></span>
			...
			<div id="navigation" class="navbar-collapse collapse">
				<ul class="navbar-nav nav-justified w-100">
					<li class="nav-item"><a href="#visao-geral" class="nav-link" rel="nofollow">Visão Geral</a></li>

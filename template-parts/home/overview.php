<section class="wrapper overview" id="visao-geral">
  <div class="container">

    <div class="row d-flex align-items-center">

      <div class="col-md-5 text-center overview-slider slick-slider">
        <div><img src="<?= ASSETS_IMAGES_URI; ?>/overview/socialbase-solucao-de-comunicacao1.svg" width="480" height="400" class="img-fluid" alt="Uma solução de comunicação" /></div>
        <div><img src="<?= ASSETS_IMAGES_URI; ?>/overview/socialbase-solucao-de-comunicacao2.svg" width="480" height="400" class="img-fluid" alt="Uma solução de comunicação" /></div>
        <div><img src="<?= ASSETS_IMAGES_URI; ?>/overview/socialbase-solucao-de-comunicacao3.svg" width="480" height="400" class="img-fluid" alt="Uma solução de comunicação" /></div>
      </div>
    ...
    <div class="row d-flex align-items-center mt-100">
      ...
      <div class="col-md-5 order-lg-2 text-center">
        <img src="<?= ASSETS_IMAGES_URI; ?>/overview/socialbase-sucesso-do-cliente.svg" width="488" height="500" class="img-fluid" alt="Sucesso do Cliente" />
      </div>

      <div class="col-md-6 offset-md-1 mt-5 mt-md-0">
        <p class="subtitle">Sucesso do Cliente</p>
